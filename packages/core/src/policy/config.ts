...
export function createPolicyUpdater(
  ...
  const handler = async (message: UpdatePolicy) => {
  ...
  messageBus.subscribe(MessageBusType.UPDATE_POLICY, handler);
  return () => messageBus.unsubscribe(MessageBusType.UPDATE_POLICY, handler);
}
