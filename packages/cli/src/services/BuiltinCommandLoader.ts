...
export class BuiltinCommandLoader implements ICommandLoader {
  ...
  async loadCommands(_signal: AbortSignal): Promise<SlashCommand[]> {
    ...
    const allDefinitions: Array<SlashCommand | null> = [
      ...
      themeCommand,
      toolsCommand,
      ...(this.config?.isSkillsSupportEnabled() ? [(await import('../ui/commands/skillsCommand.js')).skillsCommand] : []),
      ...(this.config?.isAgentsEnabled() ? [(await import('../ui/commands/agentsCommand.js')).agentsCommand] : []),
      settingsCommand,
      vimCommand,
      setupGithubCommand,
