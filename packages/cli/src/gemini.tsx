...
export async function startInteractiveUI(
  ...
  const AppWrapper = () => {
    ...
    useInput(() => {}); // Keep raw mode on for the entire app lifetime
    return (
...
export async function main() {
  ...
  // may have side effects.
  {
    ...
    const cleanupPolicyUpdater = createPolicyUpdater(policyEngine, messageBus);
    registerCleanup(async () => cleanupPolicyUpdater());
